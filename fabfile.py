...
def dev():
    ...
    env.remote = 'origin'
    env.branch = 'master'
    env.hosts = ['dev.traviscircle.com']
    env.dotenv_path = '/home/ubuntu/dev/traviscircle/.env'
...
def qa():
    ...
    env.remote = 'origin'
    env.branch = 'qa'
    env.hosts = ['qa.traviscircle.com']
    env.dotenv_path = '/home/ubuntu/qa/traviscircle/.env'
    env.config_setter = fab.run
...
def prod():
    ...
    env.remote = 'origin'
    env.branch = 'prod'
    env.hosts = ['prod.traviscircle.com']
    env.dotenv_path = '/home/ubuntu/prod/traviscircle/.env'
    env.config_setter = fab.run
