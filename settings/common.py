"""Django settings for traviscircle project.
...
APPS_DIR = ROOT_DIR.path('traviscircle')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'traviscircle.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'traviscircle.users.auth.backends.UserTokenAuthentication',

        # Mainly used for api debug.
        'rest_framework.authentication.SessionAuthentication',
    ),
    'EXCEPTION_HANDLER': 'traviscircle.base.exceptions.exception_handler',
}
...
SITE_NAME = env("SITE_NAME", default='traviscircle')
...
FRONTEND_SITE_NAME = env('FRONTEND_SITE_NAME', default='traviscircle')
...
# URL CONFIGURATION
# ------------------------------------------------------------------------------
ROOT_URLCONF = 'traviscircle.urls'
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL',
                         default='traviscircle <support@traviscircle.com>')
EMAIL_SUBJECT_PREFIX = env('EMAIL_SUBJECT_PREFIX', default='[traviscircle] ')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/traviscircle'),
}
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'traviscircle.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'traviscircle.base.views.csrf_failure'
...
def get_release():
    ...
    import os
    import raven
    release = traviscircle.__version__
    try:
