...
Minimum requirements: **pip, fabric, python3, node, npm, redis & [PostgreSQL 10][install-postgres]**, setup is tested on Mac OSX only.
...
In your terminal, type or copy-paste the following:
    ...
    git clone git@github.com:CuriousLearner/traviscircle-web.git; cd traviscircle-web; fab init
...
[contributing]: http://github.com/CuriousLearner/traviscircle-web/tree/master/CONTRIBUTING.md
